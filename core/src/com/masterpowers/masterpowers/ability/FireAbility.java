...
import com.masterpowers.masterpowers.Element.SubElement;
import com.masterpowers.masterpowers.GeneralMethods;
import com.masterpowers.masterpowers.MasterPowers;
import com.masterpowers.masterpowers.ability.util.Collision;
	...
	public static void playCombustionSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Fire.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Fire.CombustionSound.Sound' is not valid.");
			} finally {
	...
	public static void playFirebendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Fire.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Fire.FireSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playLightningbendingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Fire.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Fire.LightningSound.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playLightningbendingChargingSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Fire.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Fire.LightningCharge.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
	...
	public static void playLightningbendingHitSound(final Location loc) {
		if (getConfig().getBoolean("Properties.Fire.PlaySound")) {
			...
			try {
				...
				MasterPowers.log.warning("Your current value for 'Properties.Fire.LightningHit.Sound' is not valid.");
			} finally {
				loc.getWorld().playSound(loc, sound, volume, pitch);
			}
		}
