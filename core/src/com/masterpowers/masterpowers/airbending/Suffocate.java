package com.masterpowers.masterpowers.airbending;
...
import com.masterpowers.masterpowers.util.DamageHandler;
...
public class Suffocate extends AirAbility {
	...
	public void progress() {
		...
		if (System.currentTimeMillis() - this.getStartTime() < this.chargeTime) {
			...
			for (final LivingEntity target : this.targets) {
				...
				this.tasks.add(br2);
				this.tasks.add(br3);
				br1.runTaskTimer(MasterPowers.plugin, (long) (this.damageDelay * 20), (long) (this.damageRepeat * 20));
				br2.runTaskTimer(MasterPowers.plugin, (long) (this.slowDelay * 20), (long) (this.slowRepeat * 20 / 0.25));
				br3.runTaskTimer(MasterPowers.plugin, (long) (this.blindDelay * 20), (long) (this.blindRepeat * 20));
			}
		}
	...
	public class SuffocateSpiral extends BukkitRunnable {
		...
		public SuffocateSpiral(final LivingEntity lent, final int totalSteps, final double radius, final long interval, final double dx, final double dy, final double dz, final SpiralType type) {
			...
			this.i = 0;
			this.runTaskTimer(MasterPowers.plugin, 0L, interval);
